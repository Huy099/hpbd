const contentLetterSrart_actived = "Xin chào Giá Hần tutu dume để nghĩ văn" //Lời mở đầu cho bức thư
const mainContentLetter = 
`
 Dĩm: Chúc chị thành CEO khomm xa |     |
 Cường: Chúc bạn mau giàu ( má này xúc tích) |     |
 Thạch: Chúc Za Han không dính lời nguyền |     |
 Kiệt: chúc em hạnh phúc kiếm đc bến đỗ nối bước thanh hiền :))|     |
 Tôi: Văn phong hong tốt nên là Ditmemay (Còn chửi là còn yêu thương dữ đó)
